...
public class NigFeatureRenderer<T extends nightmare_giant, M extends NigEntityModel<T>> extends FeatureRenderer<T, M> {
    ...
    public NigFeatureRenderer(FeatureRendererContext<T, M> context, Identifier texture, AnimationAngleAdjuster<T> animationAngleAdjuster, ModelPartVisibility<T, M> modelPartVisibility) {
        super(context);
