...
public interface Renderblackorb extends TrinketRenderer {
    @Override
    default void render(final ItemStack stack,
        ...
        MinecraftClient.getInstance().getItemRenderer().renderItem(stack, ModelTransformationMode.GROUND, light, OverlayTexture.DEFAULT_UV, matrices, vertexConsumers, entity.getEntityWorld(), 0);
